...
tellraw @s ["",{"text":" ┃ ","color":"#555555"},{"text":"Author ","color":"gray"},{"text":"tickwarden","color":"aqua","underlined":true,"clickEvent":{"action":"open_url","value":"https://github.com/tickwarden/macroEngine-datapack"}}]

tellraw @s ["",{"text":" ┃ ","color":"#555555"},{"text":"Source ","color":"gray"},{"text":"github.com/tickwarden/macroEngine-datapack","color":"#5555ff","underlined":true,"clickEvent":{"action":"open_url","value":"https://github.com/tickwarden/macroEngine-datapack"}}]
# Check if loaded
