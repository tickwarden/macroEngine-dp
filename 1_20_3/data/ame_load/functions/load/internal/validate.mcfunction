execute unless data storage macro:engine global run data modify storage macro:engine global set value {version:"v3.0.0"}
data modify storage macro:engine global.version set value "v3.0.0"
...
execute if score #ame.ver_set ame.pre_version matches 1 run execute unless score #ame.patch ame.pre_version matches 60 run scoreboard players set #ame.mismatch ame.pre_version 1
